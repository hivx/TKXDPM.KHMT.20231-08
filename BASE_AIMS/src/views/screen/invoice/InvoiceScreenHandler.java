...
//
//    public InvoiceScreenHandler(Stage stage, String screenPath, Invoice invoice, List<CartMedia> selectedCartMediaList) throws IOException {
...
//        invoice.setAmount(amount);
//
//        for (CartMedia selectedCartMedia : selectedCartMediaList) {
//            try {
//                MediaInvoiceScreenHandler mis = new MediaInvoiceScreenHandler(Configs.INVOICE_MEDIA_SCREEN_PATH);
//                OrderMedia orderMedia = selectedCartMedia.toOrderMedia(); // Assuming toOrderMedia() converts CartMedia to OrderMedia
//                orderMedia.setQuantity(selectedCartMedia.getQuantity());
