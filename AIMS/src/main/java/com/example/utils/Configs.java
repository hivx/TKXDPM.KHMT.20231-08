...
public class Configs {
	...
	public static final String RESULT_SCREEN_PATH = "/result.fxml";
	public static final String SPLASH_SCREEN_PATH = ".fxml";
	public static final String CART_SCREEN_PATH = "cart.fxml";
	public static final String SHIPPING_SCREEN_PATH = ".fxml";
	public static final String CART_MEDIA_PATH = "media_cart.fxml";
	public static final String HOME_PATH  = "home.fxml";
	public static final String HOME_MEDIA_PATH = "media_home.fxml";
	public static final String POPUP_PATH = "popup.fxml";
